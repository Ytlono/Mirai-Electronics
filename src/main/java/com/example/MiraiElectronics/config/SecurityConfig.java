...
import com.example.MiraiElectronics.service.CustomUserDetailsService;
import com.example.MiraiElectronics.service.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("*")); // You can restrict this in prod
